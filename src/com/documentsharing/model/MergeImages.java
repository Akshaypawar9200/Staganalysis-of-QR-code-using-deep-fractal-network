...
public class MergeImages {
	...
	public BufferedImage extractHiddenImage(BufferedImage img) {
		...
		BufferedImage imgCopy =getScaledInstance(copyImage(img),
	...
	public static void main(String[] args) throws IOException, NoImageException {
	
	MergeImages steno=new MergeImages();
	
	BufferedImage toHide=ImageIO.read(new File("E:\\Shilpa\\ProjectGuru\\QR\\educationaldocumentsharing\\WebContent\\hybrid\\1.jpg"));
	BufferedImage mask=ImageIO.read(new File("E:/Shilpa/ProjectGuru/QR/educationaldocumentsharing/WebContent/hybrid/patch/4.png"));
	steno.setHideImage(toHide);
	steno.setMaskImage(mask);
	System.out.println("Wait beeing processed...");
	BufferedImage hide=steno.hideImage();
	File file=new File("E:/Shilpa/ProjectGuru/QR/educationaldocumentsharing/WebContent/hybrid/merge/embeded.png");
	ImageIO.write(hide, "png", file);
	System.out.println("Done!!!!!!!!! Hiding");
	
	
	BufferedImage toExtract=ImageIO.read(new File("E:/Shilpa/ProjectGuru/QR/educationaldocumentsharing/WebContent/hybrid/merge/embeded.png"));
	steno.setImageToExtract(toExtract);
	System.out.println("Wait beeing processed...");
	BufferedImage org=steno.extractHiddenImage();
	File original=new File("E:/Shilpa/ProjectGuru/QR/educationaldocumentsharing/WebContent/hybrid/merge/originalImg.jpg");
	ImageIO.write(org, "png", original);
