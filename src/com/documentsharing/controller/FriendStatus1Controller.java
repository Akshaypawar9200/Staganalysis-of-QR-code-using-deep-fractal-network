...
/**
 * Servlet implementation class FriendStatus1Controller
 */
@WebServlet("/FriendStatus1Controller")
public class FriendStatus1Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FriendStatus1Controller() {
        super();
