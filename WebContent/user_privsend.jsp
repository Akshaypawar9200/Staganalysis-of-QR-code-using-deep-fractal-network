...
<body>
	...
	<div id="wrapper">
        ...
        <%} %>
					...
					<div class="col-lg-6">						
						<hr class="colorgraph">
						<h3>Private message with secrets</h3>
						<form action="UserQRPrivSendController" method="post"
								...
								<div align="left">
											...
											<%String QRpubpath = (String)session.getAttribute("QRCodePrivate");
												if(QRpubpath!=null&&QRpubpath!=""){
											%>
											<img alt="QRCode" src="qr.jsp?filePath=<%=QRpubpath %>">
											<%} %>
											</div>
											<div align="center">
											<h3>List of Secrets</h3>
											<% ArrayList<String> secretList = (ArrayList<String>)session.getAttribute("QRCodePrivateSecrets");
												if(secretList!=null&&secretList.size()>0){
													for(int i=0;i<secretList.size();i++){
											%>	
											<img alt="QRCode" src="qr.jsp?filePath=<%=secretList.get(i) %>">		
											<%		}
												}
											%>
											</div>								
