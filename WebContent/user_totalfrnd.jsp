...
<body>
	...
	<div id="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="breadcrumb">
							...
							<li class="active">List of Friends</li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <%} %>
    		...
    		%>
    		<tr>
    			<th><img alt="Profile Pic" class="img-square" src="profilepic.jsp?id=<%=friendList.get(i).getUserId() %>"  width="50px" height="50px"/></th>
        		<th><%=friendList.get(i).getFname()+" "+friendList.get(i).getLname() %></th>
       			<th><%=friendList.get(i).getEmail() %></th>
        		<th><%=friendList.get(i).getDob() %></th>
       			<th><%=friendList.get(i).getContact() %></th>
       			<th><%=friendList.get(i).getAddress() %></th>  			
