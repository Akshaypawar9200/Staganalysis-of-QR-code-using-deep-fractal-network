...
<body>
	...
	<div id="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="breadcrumb">
							...
							<li class="active">Search Friend</li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <%} %>
					...
					<div class="col-lg-6">						
						<hr class="colorgraph">
						<form action="UserSearchController?userId=<%=userId %>" method="post" role="form" >
							
							<div class="form-group">
								<label>Search Friend</label>
								<input type="text" class="form-control" name="searchname" id="searchname" placeholder="Search Friend" />
							</div>
										
							
							<div class="text-center"><button type="submit" class="btn btn-theme">Search</button>
                   ...
                   if(listUser!=null){
                   	...
                   	<hr>
                   				...
                   				<a href="SendRequestController?followerId=<%=listUser.get(i).getUserId()%>&userId=<%=userId %>" style="color:blue">Send Request</a>
                   	 <%
						String sucMsg2 = (String)session.getAttribute("SucMsgRequest");
                   	 	Object fid = session.getAttribute("followerId");
                   	 	if(fid!= null){
                   	 	int followerId = Integer.parseInt(fid.toString());
							if(sucMsg2!=null && sucMsg2!="" && followerId==listUser.get(i).getUserId()){
					%>
						<p style="color:green"><%=sucMsg2 %></p>
					<%
							}
                   	 	}
					%>			
